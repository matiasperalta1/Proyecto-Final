...
using ProyectoFinalSeret.Models.Util;
using ProyectoFinalSeret.Models;

#nullable disable

namespace ProyectoFinalSeret.Data
{
    public partial class DBContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'sgi.accesos' since its primary key could not be scaffolded. Please see the warning messages.

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder.UseMySQL("Server=localhost; database=sgi; user=root; pwd=Anderson2010;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Chequera>(entity =>
            {
                ...
                entity.Property(e => e.ChqCodbce)
                    .HasColumnType("decimal(6,0)")
                    .HasColumnName("CHQ_CODBCE");
            ...
            modelBuilder.Entity<CtasbancPro>(entity =>
            {
                ...
                entity.Property(e => e.CbpCodmon)
                    .HasColumnType("int unsigned")
                    .HasColumnName("CBP_CODMON");
            ...
            modelBuilder.Entity<FacturascDet>(entity =>
            {
                ...
                entity.Property(e => e.FcdCodpro)
                    .HasColumnType("decimal(6,0)")
                    .HasColumnName("FCD_CODPRO");
